// CQL grammar, sourced from https://raw.githubusercontent.com/cqframework/clinical_quality_language/v1.5.2
// Capitalized to work with both ANTLR conventions and Go visibility rules.
grammar Cql;
