...
func TestIncludesListList(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
...
func TestIncludesListPoint(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
...
func TestIncludedInListList(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
...
func TestIncludedInPointList(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
...
func TestProperlyIncludesListList(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
	...
	}{
		{
			...
			wantModel: &model.ProperlyIncludes{
				BinaryExpression: &model.BinaryExpression{
					Operands: []model.IExpression{
						&model.List{
							Expression: model.ResultType(&types.List{ElementType: types.Integer}),
...
func TestProperlyIncludesPointList(t *testing.T) {
	tests := []struct {
		name       string
		cql        string
		wantModel  model.IExpression
